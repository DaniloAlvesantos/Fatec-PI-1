    ...
    <?php else: ?>
      <?php foreach ($chamadasData as $chamadaInfo): ?>
        <div class="card-secondary">
          ...
          <a href="./me/preview/edital.resultado.php?id_hae=<?php echo $chamadaInfo['id_hae']; ?>&num_chamada=<?php echo $chamadaInfo['num_chamada']; ?>&semestre=<?php echo $chamadaInfo['semestre']; ?>">
            <button
