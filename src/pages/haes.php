...
<head>
  ...
  <meta name="description" content="Confira às HAEs">
  <title>HAES | HAE Fatec Itapira</title>
...
<body>
  <header-fatec data-button-title="Home" data-button-href="./home.php"></header-fatec>
  <section>
    <h1>HAEs Disponíveis</h1>
      ...
      foreach ($all_haes as $hae) {
        ...
        echo "
          <div class='card-hae card-primary'>
              ...
              <a href='./hae_formulario.php?id={$hae['id_hae']}'>
                  <button
  ...
  <script src="../scripts/hae.js" defer></script>
</body>
